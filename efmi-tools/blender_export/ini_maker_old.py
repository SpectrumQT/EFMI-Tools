...
class IniMakerOld(IniMaker):
    ...
    def make_mod_state_group(self):
        ...
        constants.body.add_comment(r'Allows EFMI to safely disable incompatible mod and notify user about it')
        constants.body.add_command(r'global $required_efmi_version = %.2f' % self.mod_info.required_efmi_version.as_float())
        ...
        constants.body.add_command(f'global $mesh_vertex_count = {self.merged_object.vertex_count}')
        ...
        constants.body.add_comment(r'ID assigned to our mod by EFMI')
        ...
        constants.body.add_comment(r'Prevents user from being crash-locked in case of incompatible EFMI version')
        ...
        mod_disabled_body.add_comment(r'Check if our mod is compatible with installed EFMI version (runs only once)')
        ...
        mod_id_body.add_comment(r'Pass required EFMI version along with mod metadata to EFMI')
        mod_id_body.add_command(r'run = CommandListRegisterMod')

        # [CommandListRegisterMod]
        register_mod = IniSection(
            comment='Contacts EFMI to check whether installed version is compatible with our mod',
            name='RegisterMod',
            section_type=SectionType.CommandList,
        )
        self.ini.add_section(register_mod, 0)

        register_mod.body.add_comment(r'Pass mod info variables to EFMI')
        register_mod.body.add_command(r'$\EFMIv1\required_efmi_version = $required_efmi_version')
        register_mod.body.add_command(r'$\EFMIv1\object_guid = $object_guid')

        register_mod.body.add_comment(r'Pass mod info resources to EFMI')
        register_mod.body.add_command(r'Resource\EFMIv1\ModName = ref ResourceModName')
        register_mod.body.add_command(r'Resource\EFMIv1\ModAuthor = ref ResourceModAuthor')
        register_mod.body.add_command(r'Resource\EFMIv1\ModDesc = ref ResourceModDesc')
        register_mod.body.add_command(r'Resource\EFMIv1\ModLink = ref ResourceModLink')
        register_mod.body.add_command(r'Resource\EFMIv1\ModLogo = ref ResourceModLogo')

        register_mod.body.add_comment(r'Register mod in EFMI')
        register_mod.body.add_command(r'run = CommandList\EFMIv1\RegisterMod')

        register_mod.body.add_comment(r'Read mod_id assigned to our mod by EFMI, incompatible mod will get `$mod_id == -1` assigned')
        register_mod.body.add_command(r'$mod_id = $\EFMIv1\mod_id')

        register_mod.body.add_comment(r'Enable our mod if EFMI assigned valid $mod_id to it')
    ...
    def make_draw_calls_group(self):
        ...
        if self.merged_object.skeleton_type == SkeletonType.Merged:
            ...
            merge_skeleton.body.add_command(r'$\EFMIv1\custom_mesh_scale = %.2f' % self.skeleton_scale)
            ...
            merge_skeleton.body.add_command(r'run = CustomShader\EFMIv1\SkeletonMerger')
        ...
        for component_id, component in enumerate(self.extracted_object.components):
            ...
            if self.merged_object.skeleton_type == SkeletonType.Merged:
                ...
                merge_bones_condition_body.add_command(r'$\EFMIv1\vg_offset = %d' % extracted_component.vg_offset)
                merge_bones_condition_body.add_command(r'$\EFMIv1\vg_count = %d' % extracted_component.vg_count)
    ...
    def make_shape_keys_override_group(self):
        ...
        setup_shapekeys.body.add_command(f'$\EFMIv1\shapekey_checksum = {self.extracted_object.shapekeys.checksum}')
        ...
        setup_shapekeys.body.add_command(r'run = CustomShader\EFMIv1\ShapeKeyOverrider')
        ...
        load_shapekeys.body.add_command(f'$\EFMIv1\shapekey_vertex_count = $shapekey_vertex_count')
        ...
        load_shapekeys.body.add_command(r'run = CustomShader\EFMIv1\ShapeKeyLoader')

        # [TextureOverrideShapeKeyLoaderCallback]
        loader_cs_callback = IniSection(
            comment='Handles EFMI callback fired on original Shape Key Loader CS call',
        ...
        mod_enabled_body.add_comment(r'Ensure that callback has EFMI filter_index of Shape Key Loader CS assigned')
        ...
        multiply_shapekeys.body.add_command(r'$\EFMIv1\custom_vertex_count = $mesh_vertex_count')
        multiply_shapekeys.body.add_comment(r'Run custom Shape Key Multiplier CS to set deformation intensity')
        multiply_shapekeys.body.add_command(r'run = CustomShader\EFMIv1\ShapeKeyMultiplier')
        ...
        if self.unrestricted_custom_shape_keys:
            ...
            apply_shapekeys.body.add_command(r'run = CustomShader\EFMIv1\ShapeKeyApplier')
        ...
        multiplier_cs_callback = IniSection(
            comment='Handles EFMI callback fired on original Shape Key Multiplier CS call',
        ...
        mod_enabled_body.add_comment(r'Ensure that callback has EFMI filter_index of Shape Key Multiplier CS assigned')
    ...
    def make_autogenerated_group(self):
        msg = 'This mod.ini was automatically generated by EFMI Tools Blender addon v%s and requires EFMI v%s+ to function' % (
            self.mod_info.efmi_tools_version, self.mod_info.required_efmi_version
        )
        self.ini.set_group_footer(8, (
            ...
            '\n'
            f'; {msg}' + '\n'
            '; EFMI GameBanana: https://gamebanana.com/tools/17252' + '\n'
            '; EFMI Tools GameBanana: https://gamebanana.com/tools/17289' + '\n'
            '; EFMI GitHub: https://github.com/SpectrumQT/EFMI' + '\n'
            '; EFMI Tools GitHub: https://github.com/SpectrumQT/EFMI_Tools' + '\n'
