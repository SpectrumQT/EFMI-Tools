...
class EFMI_MergeVertexGroups(bpy.types.Operator):
    bl_idname = "efmi_tools.merge_vertex_groups"
...
class EFMI_FillGapsInVertexGroups(bpy.types.Operator):
    """
    ...
    """
    bl_idname = "efmi_tools.fill_gaps_in_vertex_groups"
...
class EFMI_RemoveUnusedVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "efmi_tools.remove_unused_vertex_groups"
...
class EFMI_RemoveAllVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "efmi_tools.remove_all_vertex_groups"
...
class EFMI_ApplyModifierForObjectWithShapeKeysOperator(bpy.types.Operator):
    bl_idname = "efmi_tools.apply_modifier_for_object_with_shape_keys"
...
class EFMI_CreateMergedObject(bpy.types.Operator):
    bl_idname = "efmi_tools.create_merged_object"
...
class EFMI_ApplyMergedObjectSculpt(bpy.types.Operator):
    bl_idname = "efmi_tools.apply_merged_object_sculpt"
...
class EFMI_ApplyMergedObjectSculptWithShapekeys(bpy.types.Operator):
    bl_idname = "efmi_tools.apply_merged_object_sculpt_with_shapekeys"
...
class EFMI_ConvertVertexColors(bpy.types.Operator):
    bl_idname = "efmi_tools.convert_vertex_colors"
